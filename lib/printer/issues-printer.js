...
module.exports = {
  ...
  printIssueCompleteDetails (issue/*: IssueDetails*/) {
    PrintUtils.printLine(issue.key + ': ' + issue.summary);
    PrintUtils.printLine(issue.description || '');
    
    issue.children.forEach(issue => {
      PrintUtils.printLine('---------------------------');
      module.exports.printIssueCompleteDetails(issue)
    })
  }
};
